...
==== v1.3.5 (???)
    * Suppression du besoin de selection de l'utilisateur
    * Plus besoin que les actions réfèrent l'état auxquel elles sont liées sauf si multi-prises ou multi-relay (on split)
    ...
    * Mise à jour de Homebridge en 0.4.33 et HAP-Nodejs en 0.4.36
