...
* *Plateforme Homebridge supplémentaire* : Permet de rajouter manuellement une plateforme (caméra ou Nest par exemple).

* *Accessoire Homebridge supplémentaire* : Permet de rajouter manuellement un accessoire (freemote par exemple).
