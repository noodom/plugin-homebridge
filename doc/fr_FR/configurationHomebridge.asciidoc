...
Une fois les cases *Utilisateur, nom Homebridge et PIN Homebridge* correctement renseignées, finalisez la configuration en cliquant sur **sauvegarder**. Le démon redémarre.
