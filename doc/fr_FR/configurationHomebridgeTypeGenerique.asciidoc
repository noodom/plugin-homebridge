...
===== Alarme
Plugin Officiel pris en charge, Modes associables aux modes HomeKit
...
0 = Sabotage
| Info/Choc | NON | Générique
| Info/Pression | NON | Générique
| Info/Son (dB) | NON | Générique
| Info/UV | NON | Générique
...
| Pluie (accumulation) | NON | Générique
| Pluie (mm/h) | NON | Générique
| Vent (direction) | NON | Générique
| Vent (vitesse) | NON | Générique
|===
