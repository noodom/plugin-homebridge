...
<form class="form-horizontal">
	<fieldset>
		...
		<div class="form-group">
			...
			</div><img id="qrCode" style="padding-left:100px" title="Fonctionne uniquement pour ajouter Jeedom, pour les plateformes supplémentaire, utilisez le PIN" src="" border="0" />
		</div>
		<div class="form-group">
